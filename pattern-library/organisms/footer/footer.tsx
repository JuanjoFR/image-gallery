    ...
    <React.Fragment>
      <div className="grid grid-cols-1 items-center md:grid-cols-2">
        <div className="my-8 md:mb-0">
          <StopIcon className="mb-2 h-6 w-6 text-gray-300" />
          <div className="mb-2 mr-4 h-2 w-56 rounded-md bg-gray-300" />
          <div className="mb-2 mr-4 h-2 w-52 rounded-md bg-gray-300" />
          <div className="mr-4 h-2 w-32 rounded-md bg-gray-300" />
        </div>
      ...
      <div className="mb-8 grid grid-cols-2 items-center gap-2">
        <div className="mr-4 h-2 w-24 rounded-md bg-gray-300" />
        <div className="flex justify-end">
          <StopIcon className="mr-1 h-5 w-5 text-gray-300" />
          <StopIcon className="mr-1 h-5 w-5 text-gray-300" />
          <StopIcon className="mr-1 h-5 w-5 text-gray-300" />
          <StopIcon className="h-5 w-5 text-gray-300" />
        </div>
      </div>
    </React.Fragment>
  )
